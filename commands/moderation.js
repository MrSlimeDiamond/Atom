...
module.exports = {
    data: new Discord.SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            ...
            .addIntegerOption(option => option.setName("amount").setDescription("The amount of messages to remove").setRequired(true))
            )
            ...
            async execute(interaction) {
                ...
                if (interaction.options.getSubcommand() == "purge") {
                    ...
                    .setDescription("Deleted " + amount + " messages from <#" + interaction.channel.id + ">")
