// THANKS AMJ YOU ARE SO COOL
// https://github.com/ThisAMJ/thisamj.github.io/blob/main/lib/P2Data.js

class P2Data {
    constructor() {
        let genericTriggers = coop =>
            ['"Start" load action=force_start'].concat(
                coop
                    ? [
                          '"Flags 1" flags',
                          '"Flags 2" flags "ccafter=Flags 1" action=stop',
                      ]
                    : ['"Flags" flags action=stop']
            )
        let chapterLast = '',
            chapterIdx = 0
        let P2Map = e => ({
            ...
            formattedWiki: '',
            cmAvailability:
                Math.floor(e[4] / 10000) >= 6 ? 0 : e[4] > -1 ? 1 : -1,
        })
        this.maps = [
            P2Map([
                'sp_a1_intro1',
            ...
            P2Map([
                ...
                false,
                47458,
                `Asked that [first]. ... I'm just gonna [wait]`,
            ]),
            ...
            P2Map([
                ...
                false,
                47738,
                `Congratulate you on beating [*] the odds`,
            ]),
            P2Map([
            ...
            P2Map([
                ...
                false,
                47752,
                `Guess 'sharks'? Because [that's] wrong`,
            ]),
            P2Map([
            ...
            P2Map([
                ...
                false,
                47770,
                `Look at things objectively, [see] what you`,
            ]),
            ...
            P2Map([
                ...
                false,
                47469,
                `Special safety [door] that won't`,
            ]),
            ...
            P2Map([
                ...
                false,
                47791,
                `Help, we're gonna [change] the world`,
            ]),
            P2Map([
                'sp_a3_speed_flings',
                'Propulsion Flings',
            ...
            P2Map([
                ...
                false,
                88350,
                `Paradox idea didn't work. [And] it almost`,
            ]),
            P2Map([
                'sp_a4_tb_intro',
                'Funnel Intro',
            ...
            P2Map([
                ...
                false,
                47802,
                `I know we're in a lot [of] trouble`,
            ]),
            P2Map([
            ...
            P2Map([
                ...
                false,
                47813,
                `Any of the [crucial] functions required`,
            ]),
            P2Map([
            ...
            P2Map([
                ...
                true,
                47844,
                `Earned a break [from] the official`,
            ]),
            ...
            P2Map([
                ...
                true,
                47854,
                `Completing this test, a reward for [t]esting`,
            ]),
            P2Map([
                'mp_coop_wall_block',
                'Catapult Block',
            ...
            P2Map([
                ...
                true,
                52691,
                `Can go any further, [*] I will need`,
            ]),
            P2Map([
                'mp_coop_tbeam_end',
                'Turret Warehouse',
            ...
            P2Map([
                ...
                true,
                52711,
                `Number one request? [*] Less deadly tests`,
            ]),
            P2Map([
            ...
            P2Map([
                ...
                true,
                52715,
                `Ever write a historica[l] document`,
            ]),
            P2Map([
            ...
            P2Map([
                ...
                true,
                52738,
                `Subjects to monsters is about [*] a million`,
            ]),
            P2Map([
    ...
    getCMChapterIdx() {
        ...
        for (let i = 0; i < this.maps.length; i++) {
            if (this.maps[i].cmAvailability == -1)
                this.maps[i].cmChapterIdx = -1
            ...
            e.triggers = e.triggers.map(e => {
                ...
                let args = e
                    ...
                    .map((e, f, g) => {
                        ...
                        if (
                            property.length > 1 &&
                            ['center', 'size', 'angle'].indexOf(property[0]) >
                                -1
                        ) {
                            property[1] = property[1]
                                .split(',')
                                .map(e =>
                                    func(parseFloat(e), g[0], property[0])
                                )
                                .join(',')
                        }
    ...
    async getMtriggers() {
        ...
        return queryAPI(
            this.maps
                .filter(e => e.cmAvailability > -1)
                .map(
                    e =>
                        'https://raw.githubusercontent.com/p2sr/portal2-mtriggers/master/' +
                        (e.coop ? 'Coop/' : 'SP/') +
                        e.chapter.toString().padStart(2, '0') +
                        '_' +
                        this.chapters[e.coop ? 'mp' : 'sp'][
                            e.chapter - (e.coop ? 0 : 1)
                        ]
                            .toLowerCase()
                            .replaceAll(' ', '-') +
                        '/' +
                        e.cmChapterIdx.toString().padStart(2, '0') +
                        '_' +
                        e.splitname.toLowerCase().replaceAll(' ', '-') +
                        '.cfg'
                )
        ).then(e => {
            let count = e.length
            for (let i = 0; i < count; i++) {
                ...
                map.triggers = e[i]
                    .split('\n')
                    .filter(e => e.startsWith('sar_speedrun_cc_rule '))
        ...
        return queryAPI(
            ...
            .then(e =>
                e.reduce(
                    (acc, val) =>
                        acc.concat(
                            Object.keys(val.query.pages).reduce(
                                (f, g) => f.concat(val.query.pages[g]),
                                []
                            )
                        ),
                    []
                ...
                for (let i = 0; i < count; i++) {
                    ...
                    if (e[i].hasOwnProperty('revisions')) {
                        ...
                        if (txt.startsWith('#REDIRECT')) {
                            ...
                            console.error(
                                `WIKI: Couldn't get ${map.wikiname} : ERROR 302`
                            )
                        } else {
                            map.wikicontent = txt
                        }
                        ...
                        console.error(
                            `WIKI: Couldn't get ${map.wikiname} : ERROR 404`
                        )
                    }
                }
                return target
    ...
    async getBoards() {
        ...
        return queryAPI(
            this.maps.map(
                e => `https://board.portal2.sr/chamber/${e.chamberID}/json`
            ),
            r => r.json()
        ).then(e => {
    ...
    formatWiki() {
        this.maps.map(
            e => (e.formattedWiki = e.wikicontent.replaceAll('\n', '<br>'))
        )
        for (let map of this.maps) {
            ...
            for (let i = 0; i < lineCount; i++) {
                ...
                if (lines[i].startsWith(' ')) {
                    ...
                    map.formattedWiki[map.formattedWiki.length - 1] =
                        lines[i - 1] + '</pre>'
                    pre = false
                }
                ...
                while (
                    lines[i].indexOf('[[') > -1 &&
                    lines[i].indexOf(']]') > lines[i].indexOf('[[')
                ) {
                    ...
                    if (content.startsWith('[[Category:')) {
                        ...
                        link =
                            ...
                            link.replaceAll(' ', '_').replaceAll('"', '%22')
                        lines[i] = lines[i].replace(
                            content,
                            `<a href="${link}" target="_blank">${display}</a>`
                        )
                    }
                    if (start == lines[i].indexOf('[['))
                        lines[i] = lines[i].replace(content, '')
                }
                ...
                if (trimmedLine.startsWith('{{')) {
                    ...
                    switch (insideArgs[0]) {
                        ...
                        case 'P2_Infobox':
                            // page title
                            map.formattedWiki.push(
                                `<h1 class="p2title">${insideArgs[1]}</h1>`
                            )
                            break
                        case 'P2 Image':
...

                {
                    let j = 0
                    while (
                        lines[i][j] + trimmedLine[trimmedLine.length - j - 1] ==
                        '=='
                    ) {
                        j++
                    }
            ...
            map.formattedWiki = map.formattedWiki
                .join('<br>')
                .replaceEvery('<br><br><br>', '<br><br>')
        }
    }
    ...
    convertMtriggers() {
        ...
        let zip = new JSZip()
        this.maps
            .filter(e => 0 < e.triggers.length)
            .map(P2Map => {
                let mtriggers = []
                mtriggers.push('!name ' + P2Map.splitname)
                mtriggers.push('!map ' + P2Map.filename)
                mtriggers.push(
                    ...P2Map.triggers.map((e, f, g) => {
                        if (e == '"Start" load action=force_start')
                            return '!start load'
                        let name = e.split('"')[1]
                        ...
                        if (P2Map.coop) {
                            if (e == 'Flags 1: flags') {
                                ...
                                e == 'Flags 2: flags "ccafter=Flags 1"'
                            ) {
