    ...
    public void bridgeCommand(CommandEvent event) {
        ...
        if (event.getSubcommandName().equals("pipe")) {
            try {
                ...
                event.replyEmbeds(EmbedUtil.genericIncorrectUsageEmbed("Usage: bridge pipe <on/off>"));
            }
            ...
            try {
                ...
                event.replyEmbeds(EmbedUtil.genericIncorrectUsageEmbed("Usage: bridge set <channel name>"));
            } catch(SQLException e) {
                event.replyEmbeds(EmbedUtil.expandedErrorEmbed("SQLException! Is the database down?"));
            }
