...
import net.slimediamond.atom.discordbot.commands.PingCommand;
import net.slimediamond.atom.discordbot.commands.Portal2BoardCommand;
import net.slimediamond.atom.discordbot.commands.ReactionRolesCommand;
import net.slimediamond.atom.discordbot.commands.WhoamiCommand;
import net.slimediamond.atom.discordbot.commands.amplicity.AmplicityTimeplayed;
import net.slimediamond.atom.discordbot.commands.bridge.BridgeCreateCommand;
import net.slimediamond.atom.discordbot.commands.bridge.BridgeDeleteCommand;
import net.slimediamond.atom.discordbot.commands.endpoint.EndpointAddCommand;
import net.slimediamond.atom.discordbot.commands.endpoint.EndpointListCommand;
import net.slimediamond.atom.discordbot.commands.endpoint.EndpointPipeCommand;
import net.slimediamond.atom.discordbot.commands.endpoint.EndpointRemoveCommand;
import net.slimediamond.atom.discordbot.commands.info.InfoBotCommand;
import net.slimediamond.atom.discordbot.commands.info.InfoHostCommand;
import net.slimediamond.atom.discordbot.commands.irc.IRCNamesCommand;
import net.slimediamond.atom.discordbot.commands.irc.IRCWhoisCommand;
import net.slimediamond.atom.discordbot.commands.logger.LoggerChannelSetCommand;
import net.slimediamond.atom.discordbot.commands.logger.LoggerChannelUnsetCommand;
import net.slimediamond.atom.discordbot.commands.minecraftonline.BansCommand;
import net.slimediamond.atom.discordbot.commands.minecraftonline.BanwhyCommand;
import net.slimediamond.atom.discordbot.commands.minecraftonline.FirstseenCommand;
import net.slimediamond.atom.discordbot.commands.minecraftonline.LastseenCommand;
import net.slimediamond.atom.discordbot.commands.minecraftonline.PlaytimeCommand;
import net.slimediamond.atom.discordbot.commands.pinnerino.PinnerinoBlacklistCommand;
import net.slimediamond.atom.discordbot.commands.pinnerino.PinnerinoChannelCommand;
import net.slimediamond.atom.discordbot.commands.pinnerino.PinnerinoEmojiCommand;
import net.slimediamond.atom.discordbot.commands.pinnerino.PinnerinoThresholdCommand;
import net.slimediamond.atom.discordbot.commands.streams.StreamsAddCommand;
import net.slimediamond.atom.discordbot.commands.streams.StreamsChannelCommand;
