package net.slimediamond.atom.discordbot.commands.endpoint;
...
public class EndpointAddCommand implements DiscordCommandExecutor {
    ...
    public void execute(DiscordCommandContext context) throws Exception {
        ...
        switch (type.toLowerCase()) {
            case "discord" ->
                    chat.addEndpoint((new DiscordBridgeEndpoint(context.getAPI().getJDA().getTextChannelById(unique), unique, endpointId, true)));
            case "irc" ->
