...
data class ServiceContainer(val name: String, val instance: Any, val logger: Logger) {
    ...
    fun start(cause: Cause) {
        Atom.instance.eventManager.post(ServiceStartEvent(cause, this, instance.javaClass))
    }

    fun stop(cause: Cause) {
        Atom.instance.eventManager.post(ServiceStopEvent(cause, this, instance.javaClass))
    }
